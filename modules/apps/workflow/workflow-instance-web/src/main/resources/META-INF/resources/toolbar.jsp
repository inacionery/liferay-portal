...
>
	...
	<liferay-frontend:management-bar-filters>
		<liferay-frontend:management-bar-filter
			label="status"
			managementBarFilterItems="<%= workflowInstanceViewDisplayContext.getManagementBarStatusFilterItems() %>"
			value="<%= workflowInstanceViewDisplayContext.getManagementBarStatusFilterValue() %>"
		/>
