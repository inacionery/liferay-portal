...
public class Query {
	 ...
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {apps(appDeploymentTypes: ___, appStatus: ___, keywords: ___, page: ___, pageSize: ___, sorts: ___, userIds: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public AppPage apps(
			@GraphQLName("appDeploymentTypes") String[] appDeploymentTypes,
			@GraphQLName("appStatus") String appStatus,
		...
		return _applyComponentServiceObjects(
			...
			appResource -> new AppPage(
				appResource.getAppsPage(
					appDeploymentTypes, appStatus, keywords, userIds,
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {app(appId: ___){appDeployments, appStatus, dataDefinitionId, dataDefinitionName, dataLayoutId, dataListViewId, dateCreated, dateModified, id, name, siteId, userId}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
