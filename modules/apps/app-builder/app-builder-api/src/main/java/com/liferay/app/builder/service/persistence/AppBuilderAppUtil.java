...
public class AppBuilderAppUtil {
	 ...
	 * @return the matching app builder apps
	 */
	public static List<AppBuilderApp> findByC_A(long companyId, int appStatus) {
		return getPersistence().findByC_A(companyId, appStatus);
	}
	...
	public static List<AppBuilderApp> findByC_A(
		...
		return getPersistence().findByC_A(companyId, appStatus, start, end);
	}
	...
	public static AppBuilderApp[] findByC_A_PrevAndNext(
		...
		return getPersistence().findByC_A_PrevAndNext(
			appBuilderAppId, companyId, appStatus, orderByComparator);
	}
	 ...
	 * @param appStatus the app status
	 */
	public static void removeByC_A(long companyId, int appStatus) {
		getPersistence().removeByC_A(companyId, appStatus);
	}
	 ...
	 * @return the number of matching app builder apps
	 */
	public static int countByC_A(long companyId, int appStatus) {
		return getPersistence().countByC_A(companyId, appStatus);
	}
