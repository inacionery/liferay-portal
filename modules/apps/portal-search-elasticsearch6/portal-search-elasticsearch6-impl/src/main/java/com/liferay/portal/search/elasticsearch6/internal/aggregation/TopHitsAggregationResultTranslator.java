 ...
 */
public class TopHitsAggregationResultTranslator {

	public TopHitsAggregationResult translate(TopHits topHits) {
		...
		return new TopHitsAggregationResult(
			buildHits(documents, scores, searchHits));
	}

	protected Hits buildHits(
		List<Document> documents, List<Float> scores, SearchHits searchHits) {
