 ...
 * @author Inácio Nery
 */
public abstract class BaseWorkflowable<T> implements Workflowable<T> {
	...
	public String getSummary(
		...
		try {
			AssetRenderer<?> assetRenderer = _getAssetRenderer(classPK);
	...
	public String getURLEditWorkflowTask(
			long workflowTaskId, LiferayPortletRequest liferayPortletRequest)
		throws PortalException {

		try {
			PortletURL portletURL = PortalUtil.getControlPanelPortletURL(
				liferayPortletRequest, PortletKeys.MY_WORKFLOW_TASK,
	...
	private AssetRenderer<T> _getAssetRenderer(long classPK)
		throws PortalException {
