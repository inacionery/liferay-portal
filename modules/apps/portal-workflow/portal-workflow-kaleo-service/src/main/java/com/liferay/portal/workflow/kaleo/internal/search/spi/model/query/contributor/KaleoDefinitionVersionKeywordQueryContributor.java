...
public class KaleoDefinitionVersionKeywordQueryContributor
	...
	public void contribute(
		...
		String title = GetterUtil.getString(
			searchContext.getAttribute("title"));

		if (Validator.isNotNull(title)) {
			String titleLocalizedName = LocalizationUtil.getLocalizedName(
				"title", searchContext.getLanguageId());

			searchContext.setAttribute(titleLocalizedName, title);

			queryHelper.addSearchLocalizedTerm(
				booleanQuery, searchContext, "title", false);
		}
	}
