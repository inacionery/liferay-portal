 ...
 * @author Inácio Nery
 */
public class GraphWalkerTestRule
	extends BaseTestRule<SyncHandler, SyncHandler> {

	public static final GraphWalkerTestRule INSTANCE =
		new GraphWalkerTestRule();

	private GraphWalkerTestRule() {
		super(GraphWalkerTestCallback.INSTANCE);
	}
