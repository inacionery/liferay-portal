...
public class DDMRESTDataProvider implements DDMDataProvider {
	...
	protected DDMDataProviderResponse createDDMDataProviderResponse(
		...
		DDMDataProviderResponse ddmDataProviderConsumerResponse =
	...
	protected DDMDataProviderResponse doGetData(
		...
		try {
			...
			if ((ddmRESTDataProviderResult != null) &&
				...
				return ddmRESTDataProviderResult.
					getDDMDataProviderConsumerResponse();
			}
			...
			if (ddmRESTDataProviderSettings.cacheable()) {
				_portalCache.put(
					cacheKey,
					new DDMRESTDataProviderResult(
						ddmDataProviderConsumerResponse));
			}
	...
	private static class DDMRESTDataProviderResult implements Serializable {
		...
		public DDMRESTDataProviderResult(
			...
			_ddmDataProviderConsumerResponse = ddmDataProviderConsumerResponse;
		}

		public DDMDataProviderResponse
			getDDMDataProviderConsumerResponse() {

			return _ddmDataProviderConsumerResponse;
		}

		private final DDMDataProviderResponse _ddmDataProviderConsumerResponse;
