	...
	public void onBeforeRemove(Company company) {
		...
		_deleteIndex(
			_instanceWorkflowMetricsIndexer.getIndexName(
				company.getCompanyId()));
		_deleteIndex(
			_nodeWorkflowMetricsIndexer.getIndexName(company.getCompanyId()));
		_deleteIndex(
			_processWorkflowMetricsIndexer.getIndexName(
				company.getCompanyId()));
		_deleteIndex(
		...
		_deleteIndex(
			_slaTaskResultWorkflowMetricsIndexer.getIndexName(
				company.getCompanyId()));
		_deleteIndex(
			_tokenWorkflowMetricsIndexer.getIndexName(company.getCompanyId()));
		_deleteIndex(
			_transitionWorkflowMetricsIndexer.getIndexName(
				company.getCompanyId()));
	}
