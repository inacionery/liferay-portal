...
public class ResourceHelper {
	...
	public BucketScriptPipelineAggregation
		...
		BucketScriptPipelineAggregation bucketScriptPipelineAggregation =
			_aggregations.bucketScript(
				...
				_workflowMetricsSlaBreachedInstancePercetangeScript);
	...
	protected void activate() throws IOException {
		...
		_workflowMetricsSlaBreachedInstancePercetangeScript = createScript(
			getClass(),
	...
	private Script _workflowMetricsSlaBreachedInstancePercetangeScript;
