...
public class UpgradeKaleoDefinitionVersion extends UpgradeProcess {
	...
	protected void addKaleoDefinitionVersion(
		...
		KaleoDefinition kaleoDefinition = _kaleoDefinitionLocalService.fetchKaleoDefinition(name, serviceContext);
		
		if (kaleoDefinition == null) {
			kaleoDefinition = addKaleoDefinition(groupId, userId, createDate, modifiedDate, name, title, content, version);
		}

		_kaleoDefinitionVersionLocalService.addKaleoDefinitionVersion(
			kaleoDefinition.getKaleoDefinitionId(), name, title, StringPool.BLANK, content,
