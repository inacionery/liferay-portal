...
public class KaleoTaskInstanceTokenModelListener
	...
	public void onBeforeRemove(KaleoTaskInstanceToken kaleoTaskInstanceToken) {
		_taskWorkflowMetricsIndexer.delete(
			kaleoTaskInstanceToken.getCompanyId(),
			kaleoTaskInstanceToken.getKaleoTaskInstanceTokenId());
	}
	...
	public void onBeforeUpdate(KaleoTaskInstanceToken kaleoTaskInstanceToken) {
		...
		_taskWorkflowMetricsIndexer.complete(
			kaleoTaskInstanceToken.getCompanyId(),
			kaleoTaskInstanceToken.getCompletionUserId(), completionDate,
			kaleoTaskInstanceToken.getModifiedDate(), duration.toMillis(),
			kaleoTaskInstanceToken.getKaleoTaskInstanceTokenId(),
			kaleoTaskInstanceToken.getUserId());
	}
	...
	public void onAfterUpdate(
		KaleoTaskInstanceToken kaleoTaskInstanceToken) throws ModelListenerException {
