...
public class UpdateAppBuilderAppMVCResourceCommand
	...
	@Override
	protected App saveApp(ResourceRequest resourceRequest) throws Exception {
	...
	protected AppWorkflow saveAppWorkflow(
		...
		return appWorkflowResource.putAppWorkflow(
			app.getId(),
			AppWorkflow.toDTO(
