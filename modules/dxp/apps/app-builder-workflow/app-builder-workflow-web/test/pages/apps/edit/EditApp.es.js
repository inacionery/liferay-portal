...
describe('EditApp', () => {
	...
	it('renders control menu, upperToolbar and sidebar component correctly when creating a new app', async () => {
		...
		expect(getByLabelText('form-views')).toHaveTextContent(
			'select-a-form-view'
		);
		expect(getByLabelText('table-views')).toHaveTextContent(
			'select-a-table-view'
		);
		...
		expect(getByLabelText('form-views')).toHaveTextContent('Form 01');
		expect(getByLabelText('table-views')).toHaveTextContent('Table 01');
